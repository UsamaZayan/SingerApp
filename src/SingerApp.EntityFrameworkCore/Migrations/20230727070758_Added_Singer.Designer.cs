...
{
    [DbContext(typeof(SingerAppDbContext))]
    [Migration("20230727070758_Added_Singer")]
    partial class AddedSinger
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SingerApp.Data.DataLookups.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("SingerApp.Singers.Singer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SingerApp.Singers.SingerTranslation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SingerTranslation", (string)null);
                });
            ...
            modelBuilder.Entity("SingerApp.Singers.Singer", b =>
                {
                    b.HasOne("SingerApp.Data.DataLookups.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("SingerApp.Singers.SingerTranslation", b =>
                {
                    b.HasOne("SingerApp.Singers.Singer", null)
